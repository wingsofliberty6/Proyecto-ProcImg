// ================================================
// UNIVERSAL NFT AR CONTROLLER
// ================================================

// Encuentra todos los marcadores NFT existentes
const markers = document.querySelectorAll("a-nft");

// Inicializa listeners para cada marcador
markers.forEach(marker => {
    
    marker.addEventListener("markerFound", () => {
        console.log(`📌 Marcador detectado: ${marker.id}`);
        setVisibility(marker, true);
    });
...
// ================================================
// FUNCIÓN UNIVERSAL PARA MOSTRAR/OCULTAR ELEMENTOS
// ================================================
    ...
    children.forEach(child => {
        ...
        if (child.tagName === "A-VIDEO") {
            ...
            if (mesh && mesh.material && mesh.material.map) {
                const videoEl = mesh.material.map.image;
